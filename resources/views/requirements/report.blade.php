...
<div class="container">
    ...
    <div class="export-section">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('requirements.report.export', request()->query()) }}" 
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="fecha_recepcion_desde" name="fecha_recepcion_desde" 
                               value="{{ request('fecha_recepcion_desde') }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="fecha_recepcion_hasta" name="fecha_recepcion_hasta" 
                               value="{{ request('fecha_recepcion_hasta') }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="sort_by" name="sort_by">
                            <option value="created_at" {{ request('sort_by', 'created_at') === 'created_at' ? 'selected' : '' }}>Fecha Creación</option>
                            <option value="fecha_recepcion" {{ request('sort_by') === 'fecha_recepcion' ? 'selected' : '' }}>Fecha Recepción</option>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    @if($activityRequirements->first()->activity->caso)
                                        <span class="badge badge-light ml-2">{{ $activityRequirements->first()->activity->caso }}</span>
                                    @endif
                                </div>
                                <div>
                                    <span class="badge badge-light">{{ $activityRequirements->count() }} requerimientos</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="requirement-item">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="flex-grow-1">
                                        <div class="mb-2">
                                            <strong>{{ Str::limit($requirement->description, 100) }}</strong>
                                        </div>
                                        ...
                                        @if($requirement->notas)
                                            <div class="mt-2">
                                                <small class="text-muted">
                                                    ...
                                                    {{ Str::limit($requirement->notas, 150) }}
                                                </small>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="ml-3">
                                        ...
                                        @else
                                            ...
                                            <br><small class="text-muted">
                                                {{ $requirement->created_at->diffInDays($requirement->fecha_recepcion) }} días
                                            </small>
                                        @endif
                                    </div>
                                </div>
