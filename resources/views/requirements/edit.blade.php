            ...
            <form action="{{ route('requirements.update', $requirement) }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('status') is-invalid @enderror" 
                                    ...
                                    name="status" 
                                    required>
                                <option value="pendiente" {{ old('status', $requirement->status) === 'pendiente' ? 'selected' : '' }}>
                                    <i class="fas fa-clock"></i> Pendiente
                                </option>
                                <option value="recibido" {{ old('status', $requirement->status) === 'recibido' ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" 
                              ...
                              rows="4" 
                              required
                              placeholder="Describe detalladamente qué necesitas recibir...">{{ old('description', $requirement->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="form-text text-muted">
                ...
                <div class="card bg-light mb-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <small class="text-muted">
                                    <strong>Última modificación:</strong> {{ $requirement->updated_at->format('d/m/Y H:i:s') }}
                                </small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-actions">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="{{ route('requirements.show', $requirement) }}" class="btn btn-outline-info btn-lg mr-2">
                                <i class="fas fa-eye"></i> Ver Detalles
                            </a>
